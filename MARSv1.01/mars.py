...
with z:
    st.image('img/https://github.com/T3kan0/mars/blob/main/MARSv1.01/reg.png', width=250)
with astep:
...
with col1:
    st.image('img/https://github.com/T3kan0/mars/blob/main/MARSv1.01/logo3.png')
with col2:
...
if bulk_files is not None:
    ...
    if len(n_files) == 1:
        ...
        with col4:
            ...
            st.image('img/https://github.com/T3kan0/mars/blob/main/MARSv1.01/tech.png', width=130)  
    elif len(n_files) >=2:
        ...
        with col4:
            st.write(':blue[Type : ]',uploaded_file.type)
            st.image('img/https://github.com/T3kan0/mars/blob/main/MARSv1.01/tech.png', width=120)
        with col5:
            st.write(':blue[Register ]',j+1)
